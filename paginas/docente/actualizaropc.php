<?php
	...
	$resultado2 = $base->prepare("SELECT * FROM opcion o WHERE o.id_pregunta=$codigo_pregunta");
	$resultado2->execute();
				...
				<div class=contenedor align="center">
					<div class="col-sm-9 col-xs-8">
						<div class="contenedor-form ">
							...
							<form action="../../php/actualizaropci.php" method="post" name="actualizarlect">
								...
								?>
								<input type="text" name="<?php echo $id_pregunt; ?>" value="<?php echo $opcion; ?>"required><?php echo $opcion;?><br>
								<?php
								}?>
