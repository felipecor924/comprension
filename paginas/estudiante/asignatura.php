...
<body>
	<div class="col-sm-9 col-xs-8">
		<div class="contenedor-form">
			...
			<form action="../../php/ingresarasigest.php" method="post" name="asignatura">
				...
				<select name="codigo_asignatura" id="codigo_asignatura">
					...
					<?php 
						$resultado = $base->prepare("SELECT a.nombre, a.codigo, a.codigo_programa, a.semestre 
					  	FROM asignatura a LEFT JOIN asignatura_estudiante ae ON a.codigo=ae.codigo_asignatura 
					  	WHERE ae.codigo_asignatura IS null
					  	ORDER BY a.semestre");
					  $resultado->execute();
